...
function getCorrectQuestions(skill, examId) {
    const correctMap = {
        ...
        // Lesen Teil 3 (Exams 1-35)
        'lesen3_exam1': [1, 2, 3, 4, 5], 'lesen3_exam2': [1, 2, 3, 4, 5],
        'lesen3_exam3': [1, 2, 3, 4, 5], 'lesen3_exam4': [1, 2, 3, 4, 5],
        'lesen3_exam5': [1, 2, 3, 4, 5], 'lesen3_exam6': [1, 2, 3, 4, 5],
        'lesen3_exam7': [1, 2, 3, 4, 5], 'lesen3_exam8': [1, 2, 3, 4, 5],
        'lesen3_exam9': [1, 2, 3, 4, 5], 'lesen3_exam10': [1, 2, 3, 4, 5],
        'lesen3_exam11': [1, 2, 3, 4, 5], 'lesen3_exam12': [1, 2, 3, 4, 5],
        'lesen3_exam13': [1, 2, 3, 4, 5], 'lesen3_exam14': [1, 2, 3, 4, 5],
        'lesen3_exam15': [1, 2, 3, 4, 5], 'lesen3_exam16': [1, 2, 3, 4, 5],
        'lesen3_exam17': [1, 2, 3, 4, 5], 'lesen3_exam18': [1, 2, 3, 4, 5],
        'lesen3_exam19': [1, 2, 3, 4, 5], 'lesen3_exam20': [1, 2, 3, 4, 5],
        'lesen3_exam21': [1, 2, 3, 4, 5], 'lesen3_exam22': [1, 2, 3, 4, 5],
        'lesen3_exam23': [1, 2, 3, 4, 5], 'lesen3_exam24': [1, 2, 3, 4, 5],
        'lesen3_exam25': [1, 2, 3, 4, 5], 'lesen3_exam26': [1, 2, 3, 4, 5],
        'lesen3_exam27': [1, 2, 3, 4, 5], 'lesen3_exam28': [1, 2, 3, 4, 5],
        'lesen3_exam29': [1, 2, 3, 4, 5], 'lesen3_exam30': [1, 2, 3, 4, 5],
        'lesen3_exam31': [1, 2, 3, 4, 5], 'lesen3_exam32': [1, 2, 3, 4, 5],
        'lesen3_exam33': [1, 2, 3, 4, 5], 'lesen3_exam34': [1, 2, 3, 4, 5],
        'lesen3_exam35': [1, 2, 3, 4, 5],
        
        // Sprach Teil 1 (Exams 1-40)
