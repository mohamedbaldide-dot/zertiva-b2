// ============================================
// helpLayer.js - نظام الطبقة المساعدة (نسخة متوافقة)
// ============================================

let helpLayerActive = false;
let originalContentBackup = null;

// ========== الحصول على مهارة Hören بشكل صحيح ==========
...
function createHelpBoxWithContent(questionNumber, skill, examId) {
    ...
    if (count === 10) {
        for (let row = 0; row < 5; row++) {
            ...
            for (let col = 0; col < 2; col++) {
                ...
                if (qNumber <= 10) {
                    rowDiv.appendChild(createHelpBoxWithContent(qNumber, skill, examId));
                }
            }
        ...
        for (let i = 1; i <= 5; i++) {
            column.appendChild(createHelpBoxWithContent(i, skill, examId));
        }
